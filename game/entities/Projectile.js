...
const CONFIGS = {
  standard: {
    speed: 35, life: 3,
    trail: 16,
    coreColor: 0xaa77ff, coreR: 0.035, coreLen: 1.0,
    glowColor: 0x9966ff, glowR0: 0.05, glowR1: 0.14, glowLen: 1.2, glowOp: 0.38,
    tipColor:  0xffffff, tipR: 0.065,
    trailColor: 0x9966ff, trailOp: 0.55,
  },
  rapid: {
    speed: 62, life: 2,
    trail: 8,
    coreColor: 0xdd99ff, coreR: 0.022, coreLen: 0.7,
    glowColor: 0xaa77ff, glowR0: 0.03, glowR1: 0.08, glowLen: 0.85, glowOp: 0.42,
    tipColor:  0xffffff, tipR: 0.04,
    trailColor: 0x9966ff, trailOp: 0.65,
  },
  heavy: {
    speed: 20, life: 4,
    trail: 26,
    coreColor: 0xaa77ff, coreR: 0.07,  coreLen: 1.4,
    glowColor: 0x7744ff, glowR0: 0.09, glowR1: 0.22, glowLen: 1.7,  glowOp: 0.45,
